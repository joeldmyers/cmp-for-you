...
<?php include 'includes/leftsidebar.php'; ?>
    ...
    <h2 class="pad_btm20 pad_top10 pad_left10">One time Concierge Appointment</h2>
...
if($currentTime >= $prevTime){
                ...
                $body.='<a class="noBorder" href="'.$remotelocation.'concierge_appointment.php?timeStamp='.$prevTime.'">'."<<".'</a>';
...
<input type="checkbox" onclick="get_shedule_time()" id="chk1" name="chk[]" style="margin-bottom: 10px;" value="7:00 - 8:00 AM"> 07:00 AM<br>

<input type="checkbox" onclick="get_shedule_time()" id="chk2" name="chk[]"  style="margin-bottom: 10px;" value="8:00 - 9:00 AM"> 08:00 AM<br>
<input type="checkbox" onclick="get_shedule_time()" id="chk1" name="chk[]" style="margin-bottom: 10px;" value="09:00 - 10:00 AM">09:00 AM<br>
<input type="checkbox" onclick="get_shedule_time()" id="chk1" name="chk[]" style="margin-bottom: 10px;" value="10:00 - 11:00 AM">10:00 AM<br>
...
<input type="checkbox" onclick="get_shedule_time()" id="chk1" name="chk[]" style="margin-bottom: 10px;" value="11:00 - 12:00 AM">11:00 AM<br>
<input type="checkbox" onclick="get_shedule_time()" id="chk1" name="chk[]" style="margin-bottom: 10px;" value="12:00 - 1:00 PM">12:00 PM<br>
<input type="checkbox" onclick="get_shedule_time()" id="chk1" name="chk[]" style="margin-bottom: 10px;" value="1:00 - 2:00 PM">1:00 PM<br>
...
<div class="timeshedule3" style="float: left;
 ...
 <input type="checkbox" onclick="get_shedule_time()" id="chk1" name="chk[]" style="margin-bottom: 10px;" value="2:00 - 3:00 PM">2:00 PM<br>
<input type="checkbox" onclick="get_shedule_time()" id="chk1" name="chk[]" style="margin-bottom: 10px;" value="3:00 - 4:00 PM">3:00 PM<br>
<input type="checkbox" onclick="get_shedule_time()" id="chk1" name="chk[]" style="margin-bottom: 10px;" value="4:00 - 5:00 PM">4:00 PM<br>
...
<div class="timeshedule4" style="float: left;
  ...
  font-size: 11px;display:none;">
<input type="checkbox" onclick="get_shedule_time()" id="chk1" name="chk[]" style="margin-bottom: 10px;" value="5:00 - 6:00 PM">5:00 PM<br>
<input type="checkbox" onclick="get_shedule_time()" id="chk1" name="chk[]" style="margin-bottom: 10px;" value="6:00 - 7:00 PM">6:00 PM<br>
<input type="checkbox" onclick="get_shedule_time()" id="chk1" name="chk[]" style="margin-bottom: 10px;" value="7:00 - 8:00 PM">7:00 PM<br>
</div>
...
<form action="concierge_booking_confirm.php" method="post" >
