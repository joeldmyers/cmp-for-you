...
extract($_REQUEST);
$userdata =  $db->Execute("select", "SELECT * FROM " . MEDIC . "  where doctor_id = '" . $_SESSION['emp_id'] . "'");
$fdoctor_name=$userdata[0]['first_name']." ".$userdata[0]['last_name'];
$fdoctor_email=$userdata[0]['email'];
$fdoctor_phone=$userdata[0]['doctor_telephone'];
if (isset($_POST['submit']) && $_POST['action'] == 'appiontment') {
	...
	$db->Execute("insert", "insert into tbl_doctor_video(booking_fdoctor_id,bookdoc_id,doctor_availability,date,start_time,end_time) values ('" . $_SESSION['emp_id'] . "' , '" . $docid . "','" . trim(mysql_real_escape_string($appointment_time)) . "','" . date('Y-m-d') ."','$start_time','$endTime') ");				}			/*********************************************************************************************/
    ...
    <td colspan="2" style="font-size:12px;  color:#000; padding:4px 10px;"><strong> User Name </strong></td>
     <td colspan="2" style="font-size:12px;  color:#000; padding:4px 10px;"><strong>' . $userdata[0]['first_name']. '</strong></td>
    </tr>
    <tr>
    <td colspan="2" style="font-size:12px;  color:#000; padding:4px 10px;"><strong>Email</strong></td>
     <td colspan="2" style="font-size:12px;  color:#000; padding:4px 10px;"><strong> ' . $userdata[0]['last_name'] . '</strong></td>
    </tr>
    <tr>
                                                            ...
                                                            <div class="formclass"> 
																...
																<input type="hidden" name="token_id" value="<?php echo @$_REQUEST['token_id'] ?>">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-xs-5">
                                                                            <input type="text" id="name" class="form-control required"  name="name" value="<?php echo $fdoctor_name; ?>" />
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-xs-5">
                                                                            <input type="text" id="email" class="form-control required"  name="email" value="<?php echo $fdoctor_email; ?>"  />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="col-xs-3 control-label">Phone</label>
                                                                        <div class="col-xs-5">
                                                                            <input type="text" id="phone" class="form-control required"  name="phone" value="<?php echo $fdoctor_phone; ?>"  maxlength="10" minlength="10" required/>
                                                                        </div>
                                                                    </div>
