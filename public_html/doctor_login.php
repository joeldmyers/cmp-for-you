...
if(isset($_POST["doctorlogin"]) && !empty($_POST["doctorlogin"]))
{
        ...
        if(isset($loginarr[0]["doctor_id"]) && $loginarr[0]["doctor_id"] > 0 ) {
			...
			//$clientID = "1107388814";
			//$secret = "b1997c8f7903f900782f311eeaeb6d42";
			...
			//if ($signedIn) {
			 //  $user['uniqueid'] = $_SESSION["emp_id"];
			  // $user['name'] = $_SESSION["emp_name"];
			  // $user['email'] = $_SESSION["emp_email"];
			  // $user['photourl'] = $_SESSION['doctor_profilepic'];
			//}
