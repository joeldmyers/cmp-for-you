    ...
    <header class="header">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav">
            ...
            <li> <a href="<?=$remotelocation."searchdoctortodoctor.php"; ?>">Video Consult</a>                    </li>

            <li class="dropdown"><a id="dLabel" class="profile" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false">

            		Other Doctors <span class="caret"></span> </a>

            <ul class="dropdown-menu">

                 		 	<li> <a href="<?=$remotelocation."searchdoctortodoctor1.php"; ?>">Search Doctor</a>  </li>                     

                	        <li><a href="social-network-pending-request.php">Pending Request</a></li>

                		<li><a href="doctor-in-my-network.php">My Network</a></li>
    ...
    <div class="modal-header">
                ...
                <p id="FaxDownloadLink"><a href='https://account.onlinefaxes.com/Temp/TmpDownload/10180032002964295/<?php echo $fetch->Id.".pdf"; ?>'><?php echo $fetch->Id.".pdf"; ?></a></p>
                   ...
                   <li>
                        ...
                        <a href="http://community.cmpforyou.com" target="_blank">MedCommunity </a>

                    </li>
                    
                      <li>

                        <a href="<?=$remotelocation."othersearchlinks_doctors.php"; ?>" >Other Links</a>
