...
<section class="creative-sec margin-bottom-40">
  ...
  <div class="container">
    <div class="col-md-3" style="border-left:#f1f1f1 1px solid;border-right:#f1f1f1 1px solid; padding-top:21px; padding-bottom:21px; padding-left:0px;
         ...
         padding-right:0px;">
      <h4 class="panel-title"><a href="http://cmpforyou.com/patient_reg.php"><img src="<?= $remotelocation; ?>includes/images/Symptoms.png"> Symptoms</a></h4>
      <hr>
      <h4 class="panel-title"><a href="http://cmpforyou.com/patient_reg.php"><img src="<?= $remotelocation; ?>includes/images/Home_health_services.png"> Doctors</a></h4>
      <hr>
    ...
    <div class="col-md-6" style="padding-left:40px;padding-right:40px; ">
      ...
      <div><iframe src="https://player.vimeo.com/video/148320206" width="460px" height="200px" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> <p><a href="https://vimeo.com/145786948">cmpforyou</a> on <a href="https://vimeo.com">Vimeo</a>.</p></div>
      </p>
    </div>
    <div class="col-md-3" style="border-left:#f1f1f1 1px solid;border-right:#f1f1f1 1px solid; padding-top:21px; padding-bottom:21px; padding-left:0px;

         padding-right:0px;">
      <h4 class="panel-title"><a href="http://cmpforyou.com/patient_reg.php"><img src="<?= $remotelocation; ?>includes/images/docter.png"> Home Health Services</a></h4>
      <hr>
      <h4 class="panel-title"><a href="http://cmpforyou.com/patient_reg.php"><img src="<?= $remotelocation; ?>includes/images/Nursing_home.png"> Nursing Homes</a> </h4>
      <hr>
