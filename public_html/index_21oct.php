...
$message_fast="";
$doctor_id="";
//echo "select  sta_id,sta_code,sta_name FROM " . STATES;
...
if (isset($_POST['continuebtn_update'])) {
	 if (isset($_POST['doctor_id']) && $_POST['doctor_id']!='') {
		...
		$doctor_id = trim($_PO0ST['doctor_id']);
    ...
    <div class="tp-banner" style="padding:0px !important">
        ...
        <ul>	
            ...
            <li data-transition="slideright" data-slotamount="6" data-thumb=""> 
                ...
                <img src="<?= $remotelocation; ?>includes/images/heart-specialist.jpg" alt="image" />	
                ...
                <div class="caption sfb medium_grey text-center" data-x="530" data-y="1000" data-speed="1500" data-start="2500" data-easing="easeOutExpo" style="font-size:22px;color:#000; text-align:left;margin-top:-26px; ">Consult Online  Anytime Anywhere<br> Look Younger, Live Longer &  Be Happy</div>
            ...
            <li data-transition="slideright" data-slotamount="6" data-thumb=""> 
                ...
                <img src="<?= $remotelocation; ?>includes/images/emergency-services.jpg" alt="image" />	
            ...
            <li data-transition="slideup" data-slotamount="15" data-thumb=""> 
                    <img src="<?= $remotelocation; ?>includes/images/twitter_1018.jpg" alt="image" />
...
<div class="container">
<!--br>
<center><h3>Doctors & Nurses </h3></center>
<center><h5>Claim Your Free Membership & Get Free Efax</h5></center>
<div class=" mysign" style="margin:10px 0 60px 0" ><?= (isset($message) && !empty($message_fast) ? $message_fast : ''); ?>
...
if(isset($_POST['state_fast']) &&!empty($_POST['state_fast'])){
 ...
 <div class="container margin-top-40">
        ...
        <h5 class="text-center">You can locate More doctors and Nurses on our web site than 100 hospitals combined.<br><br>
</h5></div>
...
<div class="row text-center no-margin"> 
    ...
    <div class="col-md-4 bg-default">
        ...
        <div class="home-box">
            ...
            <span class="fa fa-heartbeat fa-3x" style="margin-top:50px;"></span>
            ...
            <a href="diseases.php" class="btn-rounded btn-bordered">Read more</a>
    ...
    <div class="col-md-4" style="background-color:#f7f7f7">
        ...
        <div class="home-box opening-hours clearfix">
            ...
            <a href="<?php echo $remotelocation . "patient_reg.php" ?>" class="btn btn-default signup">Sign Up Now</a>
...
<section margin-bottom-40"> 
    ...
    <div class="container text-center">
        ...
        <div class="col-md-6 col-md-push-3">
            ...
            <br/>
            <center><h5>Doctors and nurses </h5></center>
            No Paperwork   &nbsp;&nbsp; No RedTape   &nbsp;&nbsp;      Get Paid Sooner<br>

            Make Somebody Happy<br>

            Set Up Deluxe Concierge Service<br/>

            More Productive & Profitable Practice<br>

            Affordable for patients.<br>

            Win-Win solution for everybody.<br><br>



                         <!--input name="" type="button" class="btn btn-default signup" value="Sign Up Now"-->

            <a href="http://cmpforyou.com/doctor_reg.php" class="btn btn-default signup">Sign Up Now</a>
        ...
        <div class="text-center"> 
            ...
            <div class="creative-sec-thumb one">
                ...
                <figure>
                    ...
                    <img width="154" title="" alt="" class="img-circle img-thumbnail img-responsive" src="<?= $remotelocation; ?>includes/images/creative-sec-img1.jpg">

                    <figcaption>Get Sign In</figcaption>
            ...
            <div class="creative-sec-thumb two">
                ...
                <figure>
                    ...
                    <img width="266" title="" alt="" class="img-circle img-thumbnail img-responsive" src="<?= $remotelocation; ?>includes/images/creative-sec-img2.jpg">

                    <figcaption>Write out your symptoms</figcaption>
            ...
            <div class="creative-sec-thumb three">
                ...
                <figure>
                    ...
                    <img width="162" title="" alt="" class="img-circle img-thumbnail img-responsive" src="<?= $remotelocation; ?>includes/images/creative-sec-img3.jpg">

                    <figcaption>Get checked by online appointment <br>or 

                        later face to face at home <br>or elsewhere</figcaption>
            ...
            <div class="creative-sec-thumb four">
                ...
                <figure>
                    ...
                    <img width="305" title="" alt="" class="img-circle img-thumbnail img-responsive" src="<?= $remotelocation; ?>includes/images/creative-sec-img4.jpg">

                    <figcaption>Get an Advanced online video consultation.<br> You will feel as if the doctor

                        is at your bedside<br> rather than 100 miles away. Get instant connection<br> &ndash; anytime-anywhere like magic.</figcaption>
...
<div class="container"> 
    ...
    <div class="col-md-3" style="border-left:#f1f1f1 1px solid;border-right:#f1f1f1 1px solid; padding-top:21px; padding-bottom:21px; padding-left:0px;

         padding-right:0px;">

        <h4 class="panel-title"><a href="http://cmpforyou.com/patient_reg.php"><img src="<?= $remotelocation; ?>includes/images/Symptoms.png"> Symptoms</a></h4> <hr>

        <h4 class="panel-title"><a href="http://cmpforyou.com/patient_reg.php"><img src="<?= $remotelocation; ?>includes/images/Home_health_services.png"> Doctors</a></h4><hr>

        <h4 class="panel-title"><a href="http://cmpforyou.com/patient_reg.php"><img src="<?= $remotelocation; ?>includes/images/Hospitals.png"> Hospitals</a></h4> 
    ...
    <div class="col-md-6" style="padding-left:40px;padding-right:40px; ">
        ...
        <p class="welcome-txt padding-bottom-30">

        <h5 class="text-center"> The Best Medical Services That Money Can Buy Or You Can Afford </h5>Custom Medical Services believes in providing a high priority of customer service. Check out our App for service on the go.

        At Custom Medical Services, we are thrilled to make YOU the centre of an exciting healthcare policy. You no longer need to go the distance in search of treatment for your ailment. Affordable healthcare is just a click away.

        <br><span style="font-family:roboto; color:#F00; font-size:15px;">Register for FREE Whether You Are A Patient or a Doctor or Nurse or Any Service Provider.</span></p>
    ...
    <div class="col-md-3" style="border-left:#f1f1f1 1px solid;border-right:#f1f1f1 1px solid; padding-top:21px; padding-bottom:21px; padding-left:0px;
        ...
        <h4 class="panel-title"><a href="http://cmpforyou.com/patient_reg.php"><img src="<?= $remotelocation; ?>includes/images/docter.png"> Home Health Services</a></h4> <hr>

        <h4 class="panel-title"><a href="http://cmpforyou.com/patient_reg.php"><img src="<?= $remotelocation; ?>includes/images/Nursing_home.png"> Nursing Homes</a> </h4> <hr>

        <h4 class="panel-title"><a href="http://cmpforyou.com/patient_reg.php"><img src="<?= $remotelocation; ?>includes/images/Outpatient_clinic_1.png"> Outpatient Clinic</a></h4>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-sm-4 hidden-xs">
                ...
                <img src="<?= $remotelocation; ?>includes/images/mobile-hand.png" class="app-img img-responsive" alt="" title="">
            ...
            <div class="col-md-7 col-sm-8 col-xs-12">
                ...
                <div class="app-content">
                    ...
                    <p class="lead text-center">Download   CMPForYou  App 
                    ...
                    <ul class="list-unstyled app-buttons">
                        ...
                        <li><a href="#."><img src="<?= $remotelocation; ?>includes/images/app-store-btn.png" alt="" title="App Store" class="img-responsive"></a></li>
